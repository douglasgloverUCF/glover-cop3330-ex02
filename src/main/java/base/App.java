...
public class App {
    public static void main(String[] args) {
        ...
        String input = myApp.getString();
        int cCount = myApp.countChar(input);
        myApp.outputString(input, cCount);
    }
    //input
    String getString()
    {
    ...
    //output
    void outputString(String input, int cCount)
    {
        System.out.print(input + " has " + cCount + " characters.");
    }
}
